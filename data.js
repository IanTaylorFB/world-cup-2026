...
const WC_DATA = {
  ...
  knockout: {
    ...
    r32: [
      ...
      {id:"R32-81", date_bst:"2026-07-02", time_bst:"01:00", home_label:"1st Group D", away_label:"Best 3rd (B/E/F/I/J)", home_team:"United States",away_team:"Bosnia and Herzegovina", score:{h:2,a:0},goals:[{t:"United States",p:"Balogun",m:45},{t:"United States",p:"Tillman",m:82}],reds:[{t:"United States",p:"Balogun",m:64}],yt:"https://www.youtube.com/watch?v=WDWtcfLdndc", new:true},
      {id:"R32-82", date_bst:"2026-07-01", time_bst:"21:00", home_label:"1st Group G", away_label:"Best 3rd (A/E/H/I/J)", home_team:"Belgium",away_team:"Senegal", score:{h:3,a:2},goals:[{t:"Senegal",p:"H. Diarra",m:24},{t:"Senegal",p:"I. Sarr",m:51},{t:"Belgium",p:"Lukaku",m:86},{t:"Belgium",p:"Tielemans",m:89},{t:"Belgium",p:"Tielemans",m:"120+5",pen:true}],reds:[],yt:"https://www.youtube.com/watch?v=jL7UyztS_XE", new:true},
      ...
      {id:"R32-80", date_bst:"2026-07-01", time_bst:"17:00", home_label:"1st Group L", away_label:"Best 3rd (E/H/I/J/K)", home_team:"England",away_team:"DR Congo", score:{h:2,a:1},goals:[{t:"DR Congo",p:"Cipenga",m:7},{t:"England",p:"Kane",m:75},{t:"England",p:"Kane",m:86}],reds:[],yt:"https://www.youtube.com/watch?v=x24Ir5Ua4RQ", new:true},
  ...
  predictions: {
    ...
    // Odds source: FoxSports, July 2 2026. R32-80/81/82 in — England, USA, Belgium all advanced as predicted; no prediction changes.
    knockout: {
      // R32
      ...
      "R16-89": "France",        // Paraguay (actual) vs France +185 → France
      "R16-90": "Morocco",       // Canada +17500 vs Morocco +2200 → Morocco (both actual: Canada beat RSA, Morocco beat NED on pens)
      "R16-91": "Brazil",        // Brazil +1200 vs Norway +3300
      "R16-92": "England",       // Mexico +2700 vs England +850
      "R16-93": "Spain",         // Portugal +1300 vs Spain +600
      "R16-94": "United States", // USA +2500 vs Belgium +3500 (Balogun suspended R16, but odds still favour USA)
      "R16-95": "Argentina",     // Argentina +390 vs Egypt +30000
      "R16-96": "Colombia",      // Switzerland +5500 vs Colombia +3500
      // QF
      "QF-97":  "France",        // France +185 vs Morocco +2200 → France
      "QF-98":  "Spain",         // Spain +600 vs USA +3500
      "QF-99":  "England",       // Brazil +1000 vs England +850
      "QF-100": "Argentina",     // Argentina +390 vs Colombia +3500
      // SF
      "SF-101": "France",        // France +185 vs Spain +700
      "SF-102": "Argentina",     // England +850 vs Argentina +410
      // 3rd place & Final
      "3PL-103": "Spain",        // L SF-101 Spain +700 vs L SF-102 England +850 → Spain
      "FIN-104": "France",       // France +185 vs Argentina +410
    }
  }
};
